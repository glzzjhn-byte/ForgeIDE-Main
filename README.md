...
1. Navigate to our [**Releases Page**](https://github.com/glzzjhn-byte/ForgeIDE-Main/releases).
2. Look for the **Latest Release** tag and download the highest version .exe installer (e.g., CppForgeIDE_Installer_vX.X.exe).
3. Run the installer. 
